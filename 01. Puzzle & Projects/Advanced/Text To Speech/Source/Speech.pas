...
The Initial Developer of the Original Code is Alec Bergamini <alecb@o2a.com>.
Portions created by Alec Bergamini are
Copyright (C) 1996-1999 O&A Productions. http://www.o2a.com
Portions created by Microsoft are Copyright (C) 1997-1999 Microsoft Corp.
All Rights Reserved.

Last Modified: 07/28/1999
Current Version: 2.00

Known Issues:
SID_ constants are necessary so #BEGIN $ #END can be used in Interface
Definitions. There is also a reported bug that causes a compiler SY238 error
which forces us to hard code the ansi version of interface IDs in this par
file. Because we expect this bug to be fixed eventually, we've set up the
declarations so as to make the conversion over to the correct way as easy as
possible. Unfortunately this means that there are 2 occurances of each GUID
string. We only mention this because if a GUID string is found to be
incorrect it will probably be incorrect in 2 places.
==========================================================================}
...
// This includes the speech.h for C++Builder compiles
{$HPPEMIT '#include <speech.h>'}

// These are necessary so interface types can be used as parameters in C++Builder
//UNICODE
...
// Low-Level Speach Recognitions 
  ...
  ISRFindA = interface(IUnknown)
    [SID_ISRFindA]
    function Find(var srInfo: SRMODEINFOA; psrInfoRank: PSRMODEINFORANK;
  ...
  ISRFindW = interface(IUnknown)
    [SID_ISRFindW]
    function Find(var srInfo: SRMODEINFOW; psrInfoRank: PSRMODEINFORANK;
...
type
  ...
  IVoiceCmdA = interface(IUnknown)
    ...
    function MenuEnum(dwFlags: DWORD; pszApplicationFilter: PAnsiChar;
      pszStateFilter: PAnsiChar; var IVCmdEnum: IVCmdEnum): HResult; stdcall;
    function MenuCreate(pName: PVCmdNameA; pLanguage: PLanguage;
      dwFlags: DWORD; var IVCmdMenu: IVCmdMenu): HResult; stdcall;
  ...
  IVoiceCmdW = interface(IUnknown)
    ...
    function MenuEnum(dwFlags: DWORD; pszApplicationFilter: PWideChar;
      pszStateFilter: PWideChar; var IVCmdEnum: IVCmdEnum): HResult; stdcall;
    function MenuCreate(pName: PVCmdNameW; pLanguage: PLanguage;
      dwFlags: DWORD; var IVCmdMenu: IVCmdMenu): HResult; stdcall;
...
type
  ...
  IVoiceDictationA = interface(IUnknown)
    ...
    function Register(pszApplication, pszTopic: PAnsiChar; ISessionData: IStorage;
      pszSite: PAnsiChar; NotifyInterface: IVDctNotifySink;
    ...
    function TopicAddString(pszTopic: PAnsiChar; pLanguage: PLANGUAGE): HResult; stdcall;
  ...
  IVoiceDictationW = interface(IUnknown)
    ...
    function Register(pszApplication, pszTopic: PWideChar; ISessionData: IStorage;
      pszSite: PWideChar; NotifyInterface: IVDctNotifySink;
      IIDNotifyInterface: TGUID; dwFlags: DWORD): HResult; stdcall;
    ...
    function SessionDeserialize(ISessionData: IStorage): HResult; stdcall;
    function TopicEnum(pData: PSDATA): HResult; stdcall;
    function TopicAddString(pszTopic: PWideChar; pLanguage: PLANGUAGE): HResult; stdcall;
...
type
  ...
  IVoiceTextA = interface(IUnknown)
    ...
    function Register(pszSite, pszApplication: PAnsiChar;
      NotifyInterface: IVTxtNotifySink; IIDNotifyInterface: TGUID;
...
//**********************************************************************
  ...
  ISTGramComp = interface(IUnknown)      // Unicode only
    ...
    function AutoList(ISRGramCFG: ISRGramCFG): HResult; stdcall;
    function PhraseParse(pSRPhrase: PSRPhraseW; pdwCmdID: PDWORD;
      pszData: PWideChar; pdwSize: PDWORD): HResult; stdcall;
