unit UDict;
{Copyright 2000,2006 Gary Darby, Intellitech Systems Inc., www.DelphiForFun.org
...
type
 ...
 TDic=class
    ...
    Words:TStringList;
    ExpandedList:TStringList;  {Built by GetWordCount, Used by Getwordbynumber}
    ...
    function GetnextWord(var word:string;var abbrev,foreign,caps:boolean):boolean;
