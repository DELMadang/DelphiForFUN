...
{This unit contains procedure GetParens which generates a list of parenthesized
 ...
 ther character used as a placeholder where binary operators are inserted, and
 "List", the TStringlist to hold the expressions.

 The number of ways to parenthesize a set of variables is called its Catalan
 number.
 }
