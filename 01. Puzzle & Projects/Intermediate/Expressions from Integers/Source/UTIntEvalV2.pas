...
TEval=class(TObject)
 private
   ...
   value:integer; {the calculated value of the expression}
  ...
  public
    ...
    function addIntVariable(newvarname:string; newvarval:integer):boolean;

    {Evaluate an expression an return the value in "newval"}
    function evaluate(newexpression:string;var newval:integer):boolean; 
...
(*
{*********** AddVariable *********}
function TEval.addvariable(newvarname:string; newvarval:integer):boolean;
var
  varname:string;
begin
  Varname:=uppercase(newvarname);
...
{*********** AddIntVariable *********}
function TEval.addIntvariable(newvarname:string; newvarval:Integer):boolean;
var
  varname:string;
begin
  Varname:=uppercase(newvarname);
...
{********** Evaluate *********}
function TEval.evaluate(newexpression:string;var newval:Integer):boolean;
{evaluate the expression defined by the string "newexpression" and return the
 value in "newval"}
begin
  func:=newexpression;
         ...
         Function makeOpRec(const t:string):Topobj;
           ...
           begin
             ...
             begin
               ...
               if index<0 then
               begin
                 showmessage('Variable '+t+' not defined');
