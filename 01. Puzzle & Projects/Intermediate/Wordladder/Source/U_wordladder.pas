...
type
  ...
  public
    ...
    function makeDFladder(w:string;prevpos:integer):boolean;
    function makeBFLadder(w:string;prevpos:integer):boolean;
...
{local rotuines }
 ...
 function lettersdiff(w1,w2:string; var changed:integer):integer;
...
begin
  ...
  begin  {we are the main program - manage dics ourselves}
    pubDic.Loadlargedic; {load the default loaded}
  end;
  PubDic.loadlargedic;
...
{******************  TForm1. MakeDFLadder *******************}
function TWordLadderForm.MakeDFLadder(w:string;prevpos:integer):boolean;
...
{******************** TForm1.MakeBFLadder *********************}
function TWordLadderForm.makeBFLadder(w:string;prevpos:integer):boolean;
...
var
  ...
  i,j:integer;
  newword, currword, ww, msg:string;
