object Form1: TForm1
  ...
  Width = 796
  Height = 500
  Caption = 'Arrange Listbox with auto scroll (Version 4)'
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 221
    Height = 13
    Caption = 'Hold right mouse button to drag block of itemsl)'
  end
  ...
  object Memo1: TMemo
    ...
    Font.Style = []
    Lines.Strings = (
      'Version 4 adds extended selections so that blocks of items '
      'may be moved in one operation.  Since the left mouse button '
      'resets selections in TListbox controls, dragging is implemented '
      'as a "right clcik" drag.'
      ''
      'Version 3 replaced Delphi'#39's built in drag/drop processing '
  ...
  object Extendedbox: TCheckBox
    Left = 536
    Top = 328
    Width = 241
    Height = 25
    Caption = 'Allow extended item selction for block moves'
    TabOrder = 5
    OnClick = ExtendedboxClick
  end
