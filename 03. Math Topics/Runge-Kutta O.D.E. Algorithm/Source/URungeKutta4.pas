...
{This implementation of the Runge-Kutta method for solving Second Order Ordinary
 Differential Equations when inital values are known adapts two procedure from
...
{----------------------------------------------------------------------------}
{  Same as InitialCond@ndOrder except it calls a user callback function for
